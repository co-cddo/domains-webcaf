...
class TestFrameworkRouter(unittest.TestCase):
    ...
    def test_urls_added_to_urlpatterns(self):
        ...
        expected_names = [
            "objective_A",
            "principle_A1",
            "section-indicators_A1.a",
            "section-outcome_A1.a",
            "principle_A2",
            "section-indicators_A2.a",
            "section-outcome_A2.a",
            "section-indicators_A2.b",
            "section-outcome_A2.b",
            "objective_B",
            "principle_B1",
            "section-indicators_B1.a",
            "section-outcome_B1.a",
            "section-indicators_B1.b",
            "section-outcome_B1.b",
            "section-indicators_B1.c",
            "section-outcome_B1.c",
            "principle_B2",
            "section-indicators_B2.a",
            "section-outcome_B2.a",
        ]
