...
#    Database does not store the passwords
  ...
  Scenario: GDS cyber advisor can crete new System
    ...
    Then they should see a summary card with header "Ministry of Agriculture" keys "System name, System ownership,System type,Hosting and connectivity,GovAssure year,Corporate services" and values "My system, Another government organisation,It provides core infrastructure essential for other critical systems to function,Hybrid,'Yes, in 2024/25',Email and communication"
    And click button with text "Save and continue"
#    User should see the new system in the system details page
  ...
  Scenario: GDS cyber advisor can update a System
    ...
    And click button with text "Save and continue"
    Then they should see page title "Check system details"
    Then they should see a summary card with header "Ministry of Agriculture" keys "System name, System ownership,System type,Hosting and connectivity,GovAssure year,Corporate services" and values "System 3, Another government organisation,It provides core infrastructure essential for other critical systems to function,Hybrid,'Yes, in 2024/25',Email and communication"
    And click button with text "Save and continue"
#    User should see the new system in the system details page
    Then they should see page title "Manage Systems - cyber_advisor"
