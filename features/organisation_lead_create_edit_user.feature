...
#    Database does not store the passwords
  ...
  Scenario: GovAssure lead can see option to create users and create an Organisation user and then edit
    ...
    Then they should see page title "Add a user - Complete a WebCAF self-assessment - GOV.UK"
    ...
    Then they should see page title "Confirm user information - Complete a WebCAF self-assessment - GOV.UK"
  ...
  Scenario: GovAssure lead can edit user profile role
    ...
    Then they should see page title "Edit user - Complete a WebCAF self-assessment - GOV.UK"
    And enter text "Tester" for id "last_name"
