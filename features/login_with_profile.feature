...
#    Database does not store the passwords
  ...
  Scenario Outline: Valid user logs in <user_name>
    ...
    Examples:
      ...
      | admin@example.gov.uk | password | GovAssure lead - My account - Complete a WebCAF self-assessment - GOV.UK | You cannot start a new self-assessment, until your scoping document is signed off and your system has been added to WebCAF by a cyber adviser. |
