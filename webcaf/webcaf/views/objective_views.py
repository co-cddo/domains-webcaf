...
class ObjectiveView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs) -> dict[str, Any]:
        ...
        router = app_config.framework_router  # type: ignore
        parent_map: dict[str, Any] = router.framework["objectives"][objective_id.split("_")[1]]
        ...
        data["breadcrumbs"] = [
            ...
            {
                "url": reverse("edit-draft-assessment", kwargs={"assessment_id": assessment_id}),
