...
def variable_page_content(_request):
    ...
    if phase not in ["prod", "stage"]:
        ...
        context = {
            "PHASE_CLASS": "",
            "PHASE_HEADER": "Beta",
            "PHASE_CONTENT": "<div class='govuk-phase-banner__text'>Help us improve this service by <a class='govuk-link' href='https://surveys.domains.gov.uk/s/webcaf-feedback/' target='_blank'>reporting a problem or giving your feedback (opens in a new tab)</a>.</div>",
        }
