"""
Django settings for django_govuk project.
...
ROOT_URLCONF = "django_govuk.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "django_govuk.utils.variable_page_content",
            ],
        },
    },
]

WSGI_APPLICATION = "django_govuk.wsgi.application"
...
if "RDS_DB_NAME" in os.environ:
    ...
    DATABASES = {
        "default": env.db_url(default="postgresql:///django_govuk"),  # type: ignore
    }
